...
namespace DB_project
{
    public partial class Add_Supplier : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("insert into suppliers (s_id,sname,phone#,city,a_id,dated) values ('" + textBox5.Text + "','" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + dateTimePicker1.Value.Date + "')", con);
                cmd.ExecuteNonQuery();
                con.Close();
